...
| 4 | GRASP 사이클 중 27~28초 구간 지연 원인 | ✅ (2026-09-06 사용자 확인) 설계 의도였다 — GRASP 중 Pi는 **Host 명령을 의도적으로 무시하고** 식별·정렬·파지를 전부 Pi 단독으로 맡는다(`baseline_mission.py:332`, "그동안 이 사이클은 Host 명령을 읽지도 보고하지도 않는다" 참고). identify_target 1.7초는 그 안의 일부일 뿐이다 |
