...
그리퍼 캠은 쓰지 않는다. 2026-08-24 6종 수집에서 그리퍼캠 면적은 빈
그리퍼(닫힘 165990px²)가 룩을 문 상태(70384px²)보다 커서 파지 판정에 쓸 수
없다는 것이 확인됐고, 2026-08-25 그리퍼캠 경로를 통째로 제거했다. 파지
판정은 CARRY_IDLE의 load로 한다.
